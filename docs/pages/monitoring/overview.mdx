...
For higher-risk systems such as treasury custody, reserve multisigs, and validator-backed operations, also review
[High-Value Custody Monitoring](/monitoring/high-value-custody-monitoring).
