...
### [Separation of Powers & Spending Controls](./separation-of-powers-and-spending-controls)

An operating model for splitting routine spend from principal custody using bounded allowances, explicit oversight, and
periodic owner audits.
...
4. **Separate operating spend from reserves** where needed using [Separation of Powers & Spending Controls](./separation-of-powers-and-spending-controls)
5. **Follow verification protocols** from [Transaction Verification](./transaction-verification) for all large transfers
